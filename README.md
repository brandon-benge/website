...
In VS Code, run **Tasks: Run Task** from the Command Palette and select
**Preview Benge Software website**. The task starts a local server and opens
<http://localhost:8000> in your default browser. Stop the task when finished.
